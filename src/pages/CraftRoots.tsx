...
const documents = [
  {
    ...
    cta: "Read PRD →",
    href: "/documents/craftroots-prd.pdf",
  },
  {
    label: "Narrative",
    title: "Pitch Deck",
    ...
    cta: "View Deck →",
    href: "/documents/craftroots-pitch-deck.pptx",
  },
  {
    label: "Summary",
    ...
    cta: "Read Summary →",
    href: "/documents/craftroots-summary.pdf",
  },
  {
    label: "Market",
    ...
    cta: "Read Analysis →",
    href: "/documents/craftroots-competitor-analysis.pdf",
  },
  {
    label: "Experience",
    ...
    cta: "View Journey →",
    href: "/documents/craftroots-customer-journey.pdf",
  },
  {
    label: "Research",
    ...
    cta: "View Personas →",
    href: "/documents/craftroots-personas.pdf",
  },
];
